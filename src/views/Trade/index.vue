  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in userAddress" :key="address.id">
        ...
        <p @click="selectDefaultAddress(userAddress,address)">
...
export default {
  ...
  computed: {
    ...
    // 计算属性，动态获取默认被选中的默认地址，用于渲染收货地址
    defaultAddress () {
      // Array.find()方法返回符合条件的数组元素，为了防止undefined需要价格 ||{}
  ...
  methods: {
    ...
    async submitOrder () {
      ...
      if (result.code === 200) {
        ...
        // 获得 orderId 后跳转到支付页面，并将 orderId路由传参过去
