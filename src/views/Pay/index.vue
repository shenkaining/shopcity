...
export default {
  ...
  methods: {
    ...
    async open () {
      ...
      // element-ui弹框组件
      // 参数1：内容部分的html标签；参数2：title；参数3：配置api
      this.$alert(`<img src='${url}'/>`, '微信支付', {
        ...
        // 是否显示右上角关闭按钮
        showClose: false,
        // 弹窗关闭前的回调 三个参数：1、代表点击的是确定按钮或者取消按钮，2、代表所在的组件实例，3、关闭弹框的方法
