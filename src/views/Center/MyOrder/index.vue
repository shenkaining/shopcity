  ...
  <div class="order-right">
          <div class="order-content">
              ...
              <table class="order-item" v-for="order in MyOrderList.records" :key="order.id">
                ...
                <tbody>
                  <tr v-for="(good,index) in order.orderDetailList" :key="good.id">
                    ...
                    <td :rowspan="order.orderDetailList.length" v-if="index === 0" width="12%" class="center">
                      <ul class="unstyled">
                        <li>总金额</li>
            ...
            <div class="choose-order">
              <Pagination :pageNo="page" :continue="5" :pageSize="limit" :totalData="MyOrderList.total" @currentPage="currentPage"></Pagination>
            </div>
          </div>
          <!--猜你喜欢-->
          <div class="like">
